...
namespace CureWellUsingEF.Controllers
{
    ...
    {
        private readonly ISurgeryService service;
        public SurgeryController(ISurgeryService surgeryService)
        {
            this.service = surgeryService;
        }
        ...
        [HttpPost("Create")]
        public async Task<IActionResult> Create(SurgeryModal _data)
        {
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update(SurgeryModal _data, int id)
        {
